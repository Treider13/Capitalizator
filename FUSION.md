...
Рыночные потоки, исполнитель, обучение, архив, новости (пул до четырёх источников),
исторические свечи, опционы и обслуживание работают раздельно. Admission-lock
...
Актуальный [отчёт повторной проверки](docs/FUSION-REVIEW-2026-09-06.md) содержит
дефекты, их регрессии и границы доказательств. Полный набор: 2241 passed,
2 прежних skipped; 86 тестов Fusion. Проходят Ruff, исходная область mypy и
24 модуля Fusion отдельно. Проверены JavaScript, локальный HTTP/SSE и wheel.
Chromium и Docker отсутствуют; визуальная/контейнерная приёмка не заявлена.
