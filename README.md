...
Код: каркас −1.x, рекордер (jsonl→parquet, не live-час), книга/ресинк, вселенная BTC+ETH, реплеер фикстуры. Живой VPS/сутки BTC **ещё не зелёные** (`ops/STATUS.md`). Стратегии нет.
