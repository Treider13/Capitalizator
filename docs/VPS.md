...
8. Консоль: `python -m capitalizator.ops.console --userdir ./user_data --serve` → интерфейс «Хронос» на `http://127.0.0.1:8082/`. Туннель `ssh -L 8082:127.0.0.1:8082`. `POST /order` = 405. Без ленты блоки честно пустые.
