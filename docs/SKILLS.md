...
в сессии нет. Новым указанием пользователь разрешил тестирование;
локальные программные тесты выполнены в продолжении аудита. Не переносились DEX/AMM формулы
