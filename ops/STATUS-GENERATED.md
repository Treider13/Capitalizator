...
Дата: 2026-09-03T23:26:03+00:00. Этот файл пишет `python -m capitalizator.ops.gen_status`; руками не редактировать.

- Тесты: **1859 passed, 2 skipped in 31.88s**
- Ruff: **чисто**
- Модулей достижимо из точек входа: **222**; недостижимо: **0**
