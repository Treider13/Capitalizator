...
def experience_snapshot(knowledge: Knowledge) -> dict[str, Any]:
    ...
    overlay = knowledge.overlay_rows()
    ...
    return {
        ...
        "n_cards": knowledge.claim_count("b_card:"),
        "n_hash": knowledge.counts().get("hash_links", 0),
        "handoff_from": knowledge.meta(META_HANDOFF_FROM),
        "handoff_n_touches": knowledge.meta(META_HANDOFF_TOUCHES),
        "handoff_n_demo_episodes": knowledge.meta(META_HANDOFF_DEMO),
        "handoff_n_cards": knowledge.meta(META_HANDOFF_CARDS),
        "same_book": True,
    }
